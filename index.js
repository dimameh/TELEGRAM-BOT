...
Пожалуйста, укажите в сообщении предпочитаемый вид связи:
🔸Telegram
🔸Телефонный звонок
...
☺Пожалуйста напишите в чате свои ФИО, выбранный тариф обучения и в ближайшее время с вами свяжется эксперт для дальнейшей работы 👇🏽
`,
  buttons: [
    [{ text: ChatStates.DownloadProgram, }],
    [{ text: ChatStates.Question, }],
