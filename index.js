...
text: `
Отлично, напишите свой вопрос в чате и в ближайшее время с вами свяжутся❗

📌Пожалуйста, укажите в сообщении номер телефона.
...
☺Пожалуйста напишите в чате свои ФИО и выбранный тариф обучения, в ближайшее время с вами свяжется эксперт для дальнейшей работы 👇🏽

📌Укажите в сообщении номер телефона для связи.
`,
  buttons: [
    [{ text: ChatStates.DownloadProgram, }],
    [{ text: ChatStates.Question, }],
